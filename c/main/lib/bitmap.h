 ...
 *
 * Each bit represents one bit in the bitmap.  If bit 0 in an 
 * element represents bit K in the bitmap, then bit 1 in the element 
 * represents bit K+1 in the bitmap, and so on.
 */
